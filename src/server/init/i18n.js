module.exports = function(app) {
  ...
  config.set('i18n:supportedLanguages', _.map(supportedLanguages, function(lng) {
  ...
  var defaultLng = !isProduction ? config.get('i18n:defaultLanguage').toLowerCase() : 'en-us';
  ...
  i18n.init({
    ...
    lowerCaseLng: true,
    lng: defaultLng,
    fallbackLng: isDevelopment ? 'xx-xx' : defaultLng,
