  ...
  copy: {
    ...
    bower: {
      ...
      src: [
        ...
        path.join(bowerDir, 'angular-touch/angular-touch.js'),
        path.join(bowerDir, 'angular-touch/angular-touch.min.js'),
        path.join(bowerDir, 'angular-touch/angular-touch.min.js.map'),
